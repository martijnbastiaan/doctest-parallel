 ...
 * Add parallel parsing. The GHC API is now used to call the parser directly, which allows parallel parsing.  ([#85](https://github.com/martijnbastiaan/doctest-parallel/issues/89))
